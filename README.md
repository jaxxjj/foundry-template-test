...
We've specially designed a vulnerable contract in `my_foundry_project/src/VulnerableLendingPool.sol` for educational purposes. This contract contains intentional vulnerabilities that are revealed through different testing strategies:
...
👉 [Testing Strategy & Vulnerability Analysis](my_foundry_project/test/README.md)
...
See the [Deployment Guide](my_foundry_project/script/releases/README.md) for detailed Zeus usage instructions.
...
For complete setup instructions, workflow customization, and troubleshooting guides, see the [Tenderly Integration Guide](my_foundry_project/docs/TENDERLY.md).
...
The template includes several pre-configured GitHub Actions workflows located in `my_foundry_project/.github/workflows/`:
